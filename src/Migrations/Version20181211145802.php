...
final class Version20181211145802 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE item (id INT AUTO_INCREMENT NOT NULL, price_new_id INT NOT NULL, name VARCHAR(255) NOT NULL, store INT NOT NULL, member TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_1F1B251EF09F1BE3 (price_new_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
